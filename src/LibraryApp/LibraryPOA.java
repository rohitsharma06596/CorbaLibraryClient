 ...
 implements LibraryApp.LibraryOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("addItem", new Integer (0));
    _methods.put ("removeItem", new Integer (1));
    _methods.put ("listItemAvailability", new Integer (2));
    _methods.put ("borrowItem", new Integer (3));
    _methods.put ("findItem", new Integer (4));
    _methods.put ("returnItem", new Integer (5));
    _methods.put ("verify", new Integer (6));
    _methods.put ("load_server", new Integer (7));
    _methods.put ("addToWait", new Integer (8));
    _methods.put ("exchangeItem", new Integer (9));
    _methods.put ("shutdown", new Integer (10));
  }
