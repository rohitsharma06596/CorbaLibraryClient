...
import LibraryApp.LibraryHelper;
...
public class Client_Handler {
    Client_Base client;
    private  Library objCo;
    private String messageBoard;
    ORB orb;

    public Client_Handler (String [] args) throws Exception
    {
    ...
    public  boolean intialize() throws Exception
    {
        ...
        if(serverSelect.equals("CONCORDIA"))
        {
            ...
            objCo = (Library) LibraryHelper.narrow(ncRef.resolve_str("CON"));
        ...
        else if(serverSelect.equals("MCGILL"))
        {
            org.omg.CORBA.Object objRef =   orb.resolve_initial_references("NameService");
            NamingContextExt ncRef = NamingContextExtHelper.narrow(objRef);
            objCo = (Library) LibraryHelper.narrow(ncRef.resolve_str("MCG"));
     ...
     */
    public void appInteractor() throws InterruptedException, UnknownHostException {
